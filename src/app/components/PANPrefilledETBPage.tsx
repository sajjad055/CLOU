...
const processingSteps: ProcessingStep[] = [
  { id: 'etb', labelEn: 'Checking existing bank records...', labelTa: 'ஏற்கனவே உள்ள வங்கி பதிவுகளை சரிபார்க்கிறது...', durationMs: 2000 },
  { id: 'etb-found', labelEn: 'Existing customer found ✓', labelTa: 'ஏற்கனவே உள்ள வாடிக்கையாளர் கண்டறியப்பட்டது ✓', durationMs: 1500 },
  { id: 'bre', labelEn: 'Running credit eligibility check...', labelTa: 'கடன் தகுதி சோதனை நடைபெறுகிறது...', durationMs: 2000 },
  { id: 'offers', labelEn: 'Fetching your sanctioned offers...', labelTa: 'உங்கள் அனுமதிக்கப்பட்ட சலுகைகளைப் பெறுகிறது...', durationMs: 1800 },
];

export function PANPrefilledETBPage() {
  ...
  useEffect(() => {
    ...
    if (currentProcessingStep >= processingSteps.length) {
      const timer = setTimeout(() => navigate('/sanctioned-offers'), 800);
